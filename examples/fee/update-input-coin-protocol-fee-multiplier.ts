...
// yarn ts-node examples/fee/update-input-coin-protocol-fee-multiplier.ts
(async () => {
  console.warn(`Building transaction to update input coin protocol fee multiplier to ${NEW_MULTIPLIER}%`);
